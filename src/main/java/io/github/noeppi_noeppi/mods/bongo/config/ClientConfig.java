...
public class ClientConfig {
    ...
    public static void init(ForgeConfigSpec.Builder builder) {
        bongoMapScaleFactor = builder
                .comment("Controls the size of the bongo map.")
                .define("bongo_map_scale_factor", 1d);

        bongoMapOnTheRight = builder
                .comment("Whether the bongo map should be moved to the right side of the screen instead of the left.")
                .define("bongo_map_on_the_right", false);

        addItemTooltips = builder
                .comment("Whether bongo should add tooltips to items in the bingo card. This may cause a short spike of lagg when a game is created.")
